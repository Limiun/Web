var App = function () {
		...
		try {
			Dropzone.autoDiscover = false;
			  $(".dropzone").dropzone({
			    ...
			    maxFilesize:5, // MB
			    maxFiles:8,
			    acceptedFiles: ".jpg,.gif,.png,.JPG,.GIF,.PNG", //上传的类型
				addRemoveLinks : true,
				dictInvalidFileType:"无效文件格式",  
			    dictCancelUpload:"取消",
	...
	var handleBackstretch = function () {
		 $.backstretch([
		"manager/img/login/1.jpg"
		, "manager/img/login/2.jpg"
		, "manager/img/login/3.jpg"
		, "manager/img/login/4.jpg"
		, "manager/img/login/5.jpg"
