...
<head>
    	...
    	<!-- header -->
        	<header role="header">
            	<div class="container">
                	<!-- logo -->
                    	<%-- <h1>
                        	<a href="${pageContext.request.contextPath}/WebSiteServlet?yor=yor" title="Yorbest"><img src="images/logo.png" title="Yorbest" alt="Yorbest"/></a>
                        </h1> --%>
                    <!-- logo -->
                    <!-- nav -->
        ...
        <main role="main-inner-wrapper" class="container">
            <div class="row">
            	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 ">
                    ...
                    <c:forEach items="${blogList}" var="blog" varStatus="status" begin="1"  end="29"   step="2">
                        <li>
                        <a href="${pageContext.request.contextPath}/BlogServlet?blog=detail&blogId=${blog.blogId}" >
                        	<section class="blog-content">                       	
                                <figure>
                                    <div class="post-date">
                                        <span>${blog.blogTag}</span>  
                                    </div>
                                </figure>
                                 <a href="${pageContext.request.contextPath}/BlogServlet?blog=detail&blogId=${blog.blogId}">                               
                                    <article>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                	<ul class="grid-lod effect-2" id="grid">
                	   <c:forEach items="${blogList}" var="blog" varStatus="status" begin="0"  end="30"   step="2">
                        <li>
 ...
 <li><a href="https://www.facebook.com/best.yor?ref=bookmarks" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
        ...
        <script src="../yorbest/js/jquery.min.js" type="text/javascript"></script>
        <!-- custom -->
