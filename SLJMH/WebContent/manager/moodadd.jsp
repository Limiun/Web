...
<html>
  ...
  <body>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									<div class="clearfix">
										<h3 class="content-title pull-left">记录心情</h3>
									</div>
										...
										<div class="box border red">
											...
											<div class="box-body">
											  <c:if test="${empty mood}">
												<form class="form-horizontal" action="${pageContext.request.contextPath}/MoodServlet?mood=add" method="post">
												 <div class="form-group">
													<label class="col-md-1 control-label">标题</label>
													<div class="col-sm-11">
													   <input type="text" name="moodTitle" class="form-control" placeholder="Text input">
													   <input type="hidden" name="mooduserName" class="form-control" value="${user.userName}"> 
													</div>
												  </div>										  								 
                                                 <!-- CKE -->
								                 <div class="box border grey">
									               ...
									               <div class="box-body">
										           <textarea  class="ckeditor" name="moodContent" id="editor2">
										           </textarea>
									              </div>
								                </div>
							                     	<!-- /CKE -->
												    <div class="form-group">
													<label class="col-md-1 control-label">添加图片</label>
													<div class="col-sm-7">
													<input type="text" id="blogBackPic" name="moodAddfile" class="form-control" placeholder="请选择或输入URL">
													</div>
												...
												<form class="form-horizontal" action="${pageContext.request.contextPath}/MoodServlet?mood=update" method="post">
												 <div class="form-group">
													<label class="col-md-1 control-label">标题</label>
													<div class="col-sm-11">
													   <input type="text" name="moodTitle" class="form-control" placeholder="Text input" value="${mood.moodTitle}">
													   <input type="hidden" name="moodId" class="form-control" placeholder="Text input" value="${mood.moodId}">
													   <input type="hidden" name="mooduserName" class="form-control" value="${user.userName}"> 
													</div>
												  </div>							  
                                                 <!-- CKE -->
								                 <div class="box border grey">
										           ...
										           ${mood.moodContent}
													...
													<label class="col-md-1 control-label">添加图片</label>
													<div class="col-sm-7">
													<input type="text" id="blogBackPic" value="${mood.moodAddfile}" name="moodAddfile" class="form-control" placeholder="请选择或输入URL">
													</div>
												      <button   id="findpic" onclick="findPic();" type="button" class="btn btn-warning ">  
												                从本文选择图片    
												      </button>
	...
	<script type="text/javascript" src="js/add/moodadd.js"></script>
